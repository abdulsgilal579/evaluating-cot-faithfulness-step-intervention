...
MODELS = [
    "llama-3.1-8b-instant",    # Model 1 (fast, free)
    # "mixtral-8x7b-32768",    # Model 2 — uncomment when testing is done
]

ITEMS_PER_DOMAIN    = 5      # 5 per domain = 15 total (testing mode)
                              # Change to 30 for pilot, 150 for full study
REPETITIONS         = 1      # No repetition for testing
TEMPERATURE         = 0.7
